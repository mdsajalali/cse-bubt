...
const ContactForm = () => {
  return (
    <div className="container mx-auto px-4 py-8 md:flex md:gap-8 lg:gap-20">
      {/* Left Section */}
      <div className="md:w-2/3">
        ...
        <p className="mt-2 text-gray-600">
          ...
          available 24/7 via fax or email. You can also use a quick contact form
      ...
      <div className="mt-8 md:mt-0 md:w-1/3">
        <div className="space-y-6">
          ...
          <div>
            ...
            <p className="flex items-center gap-2 text-gray-600 py-2">
              <Clock size={16}/> Sun: 8:00am-3:00pm
            </p>
            <p className="text-gray-600 ml-0 lg:ml-6">Sat: Closed</p>
          </div>
        </div>
      </div>
    </div>
